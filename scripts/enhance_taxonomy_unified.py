...
CONFIDENCE_METADATA = {
    "revenue": {
        ...
        "low_confidence_signals": ["Unlabeled number", "Appears outside standard income statement"],
        "validation_boosters": [
...
GAAP_IFRS = {
    "revenue": {
        ...
        "ifrs": {
            ...
            "differences": "Largely aligned; minor disclosure differences",
        },
    },
    "inventory": {
        "us_gaap": {
        ...
        "ifrs": {
            ...
            "differences": "IFRS prohibits LIFO",
        },
    },
    "depreciation": {
        "us_gaap": {
        ...
        "ifrs": {
            ...
            "differences": "IFRS requires component depreciation",
        },
    },
    "goodwill": {
        ...
        "ifrs": {
            ...
            "differences": "IFRS prohibits reversal of goodwill impairment",
        },
    },
}
...
REGULATORY_CONTEXT = {
    ...
    "ebitda": {
        "sec_forms": ["8-K", "10-K"],
        "is_non_gaap": True,
        "disclosure_requirements": ["Must reconcile to GAAP net income"],
    },
...
def enhance(input_path: str = "data/taxonomy.json", output_path: str = "data/taxonomy.json"):
    ...
    print(
        f"✅ Phase 1: {stats['ocr']} OCR variants, {stats['format']} format examples, {stats['industry']} industry tags"
    )
    print(f"✅ Phase 2: {stats['confidence']} confidence scoring items")
    print(
        f"✅ Phase 3: {stats['gaap']} GAAP/IFRS, {stats['regulatory']} regulatory, {stats['new_items']} new industry metrics"
    )
