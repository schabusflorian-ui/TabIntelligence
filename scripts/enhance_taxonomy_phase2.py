...
PHASE2_ENHANCEMENTS = {
    ...
    "ebitda_margin": {
        ...
        "cross_item_validation": {
            "relationships": [
                {"rule": "ebitda_margin == ebitda / revenue", "tolerance": 0.005},
                {
    ...
    "interest_coverage": {
        ...
        "cross_item_validation": {
            "relationships": [
                {"rule": "interest_coverage == ebit / interest_expense", "tolerance": 0.1},
                {
    ...
    for item in data["items"]:
        ...
        if canonical_name in PHASE2_ENHANCEMENTS:
            ...
            if "cross_item_validation" in enhancement:
                ...
                item["validation_rules"]["cross_item_validation"] = enhancement[
                    "cross_item_validation"
                ]
