...
ENHANCEMENTS = {
    ...
    "cogs": {
        "ocr_variants": ["COG S", "C0GS", "COGS.", "cogs", "Co GS", "CDGS", "COGS:", "C O G S"],
        "format_examples": [
    ...
    "opex": {
        "ocr_variants": ["Op ex", "OPEX", "0pex", "OpEx", "Op-Ex", "ΟpEx"],
        "format_examples": [
    ...
    "sga": {
        "ocr_variants": ["SG A", "S G A", "SGA.", "S&G&A", "SG&A", "SGA:", "5GA"],
        "format_examples": [
    ...
    "rd_expense": {
        "ocr_variants": ["R&D", "R &D", "R&D.", "R & D", "RandD", "RɁD", "R+D"],
        "format_examples": [
    ...
    "ebit": {
        "ocr_variants": ["EB IT", "E BIT", "EB1T", "EBIT.", "Ebit", "EBlT", "EBIT:"],
    ...
    "operating_income": {
        ...
        "format_examples": [{"value": "3,000,000", "context": "Positive operating income"}],
    ...
    "interest_income": {
        ...
        "format_examples": [{"value": "10,000", "context": "Cash interest earned"}],
        "industry_tags": ["all", "financial_services", "cash_rich"],
    },
    "ebt": {
        "ocr_variants": ["E BT", "EB T", "EBT.", "Ebt", "EBT:", "ΕBT"],
        "format_examples": [{"value": "4,200,000", "context": "Pre-tax earnings"}],
    ...
    # BALANCE SHEET
    "cash": {
        "ocr_variants": ["Ca sh", "C ash", "CASH", "Cash.", "Cɑsh", "Cash:"],
        "format_examples": [
    ...
    "current_assets": {
        ...
        "format_examples": [{"value": "12,000,000", "context": "Liquid assets"}],
        "industry_tags": ["all"],
    },
    "total_assets": {
        "ocr_variants": [
    ...
    "ppe": {
        "ocr_variants": ["PP E", "P P E", "PP&E", "PPE.", "PPɆ", "PP+E"],
        "format_examples": [{"value": "15,000,000", "context": "Net property value"}],
    ...
    "intangibles": {
        ...
        "format_examples": [{"value": "5,000,000", "context": "Patents, trademarks"}],
        "industry_tags": ["technology", "pharma", "biotech", "media"],
    },
    "goodwill": {
        "ocr_variants": ["Good will", "Good-will", "GOODWILL", "Goodwill.", "Gοodwill"],
        "format_examples": [{"value": "20,000,000", "context": "Acquisition premium"}],
    ...
    "accrued_expenses": {
        ...
        "format_examples": [{"value": "500,000", "context": "Wages, interest accrued"}],
        "industry_tags": ["all"],
    },
    "current_liabilities": {
        "ocr_variants": [
        ...
        "format_examples": [{"value": "8,000,000", "context": "Short-term obligations"}],
        "industry_tags": ["all"],
    },
    "total_liabilities": {
        "ocr_variants": [
    ...
    "short_term_debt": {
        ...
        "format_examples": [{"value": "2,000,000", "context": "Debt due within 1 year"}],
    ...
    "long_term_debt": {
        ...
        "format_examples": [{"value": "15,000,000", "context": "Debt due after 1 year"}],
        "industry_tags": ["all", "leveraged", "real_estate"],
    },
    "total_debt": {
        "ocr_variants": ["Total De bt", "Total-Debt", "TOTAL DEBT", "Totɑl Debt", "Total Debt."],
        "format_examples": [{"value": "17,000,000", "context": "ST + LT debt"}],
        "industry_tags": ["all", "leveraged"],
    },
    "common_stock": {
        "ocr_variants": [
        ...
        "format_examples": [{"value": "1,000,000", "context": "Par value"}],
        "industry_tags": ["all", "public_companies"],
    },
    "retained_earnings": {
        "ocr_variants": [
    ...
    # CASH FLOW
    "cfo": {
        "ocr_variants": ["CF O", "C FO", "CFO.", "CF0", "CƑO", "CFO:"],
        "format_examples": [
    ...
    "cfi": {
        "ocr_variants": ["CF I", "C FI", "CFI.", "CFl", "CƑI", "CFI:"],
        "format_examples": [{"value": "(3,000,000)", "context": "Capex outflow"}],
        "industry_tags": ["all"],
    },
    "cff": {
        "ocr_variants": ["CF F", "C FF", "CFF.", "CƑF", "CFF:"],
        "format_examples": [
    ...
    "capex": {
        "ocr_variants": ["Cap ex", "CAPEX", "CapEx", "Cap-Ex", "Cɑpex", "CAPEX."],
        "format_examples": [
    ...
    "fcf": {
        "ocr_variants": ["FC F", "F CF", "FCF.", "FCƑ", "FCF:"],
    ...
    "net_change_cash": {
        ...
        "format_examples": [{"value": "2,500,000", "context": "Cash increased"}],
        "industry_tags": ["all"],
    },
    "beginning_cash": {
        "ocr_variants": [
        ...
        "format_examples": [{"value": "3,000,000", "context": "Starting balance"}],
        "industry_tags": ["all"],
    },
    "ending_cash": {
        "ocr_variants": [
        ...
        "format_examples": [{"value": "5,500,000", "context": "Ending balance"}],
        "industry_tags": ["all"],
    },
    # DEBT SCHEDULE
    "net_debt": {
        "ocr_variants": ["Net De bt", "Net-Debt", "NET DEBT", "Nɇt Debt"],
        "format_examples": [{"value": "12,000,000", "context": "Total debt - cash"}],
    ...
    "principal_payment": {
        ...
        "format_examples": [{"value": "1,000,000", "context": "Annual amortization"}],
        "industry_tags": ["all", "leveraged", "real_estate"],
    },
    "interest_payment": {
        "ocr_variants": [
        ...
        "format_examples": [{"value": "780,000", "context": "Annual interest"}],
        "industry_tags": ["all", "leveraged"],
    },
    # METRICS
    "ebitda_margin": {
    ...
    "net_margin": {
        "ocr_variants": ["Net Mar gin", "Net-Margin", "NET MARGIN", "Net Profit Margin", "Net %"],
        "format_examples": [
